...
before you can use it in your app, you need to know couple of things:
  ...
  - Android
    - make sure that you have done all of the android configuration described [here](http://facebook.github.io/react-native/releases/0.48/docs/getting-started.html#android-development-environment)
